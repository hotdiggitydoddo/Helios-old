...
namespace Helios.RLToolkit.Generators
{
	...
	*/
		...
		public class Door : IComparable<Door>{
			...
			int IComparable<Door>.CompareTo(Door other){	//use with .Equals()!
		...
		public	void GenerateRoomTemplateDungeon(	int?	width					= null,
			...
			StartTimeLog("generate templates:\t\t");		
		...
		private	Room CreateRoomFromTemplate(RoomTemplate roomTemplate){
			...
			Array.Copy( roomTemplate.tilesType, roomTemplateTilesTypeCopy, xSizeRoom *ySizeRoom );
		...
		private	void MarkPotentialDoors(RoomTemplate roomTemplate ){
			...
			Array.Copy( roomTemplate.tilesType, roomTemplateTilesTypeCopy, xSize*ySize );
		...
		*/				
		...
		private	bool _canCarve(IntVector2 pos, IntVector2 direction) {
			...
			Vector2f v2 = new Vector2f(iv2.x, iv2.y);
		...
		public void ShowMap()
		{
			instance.GenerateHauberkDungeon();
			var tiles = _dungeon;
